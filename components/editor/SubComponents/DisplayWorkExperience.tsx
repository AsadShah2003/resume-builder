...
const DisplayWorkExperience: React.FC<DisplayWorkExperienceProps> = ({
  ...
  const setWorkExperiece = useResumeStore((state) => state.setWorkExperiece);
  const workExperience = useResumeStore((state) => state.workExperience);
  const setWorkExpErrors = useResumeStore((state) => state.setWorkExpErrors);
  const workExpErrors = useResumeStore((state) => state.workExpErrors);
  const setShowElements = useResumeStore((state) => state.setShowElements);
